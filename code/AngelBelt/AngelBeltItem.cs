...
//            handling = EnumHandHandling.Handled;
        ...
        public override void OnBeforeRender(ICoreClientAPI capi, ItemStack itemstack, EnumItemRenderTarget target, ref ItemRenderInfo renderinfo)
        {
            ...
            Dictionary<string, MeshRef> orCreate = ObjectCacheUtil.GetOrCreate<Dictionary<string, MeshRef>>(capi, "armorMeshRefs", () => new Dictionary<string, MeshRef>());
            string key = "armorModelRef-" + itemstack.Collectible.Code.ToString();
            if (!orCreate.TryGetValue(key, out renderinfo.ModelRef))
            {
                renderinfo.ModelRef = (orCreate[key] = this.genMeshRef(capi, itemstack, renderinfo));
            }
        ...
        private MeshRef genMeshRef(ICoreClientAPI capi, ItemStack itemstack, ItemRenderInfo renderinfo)
        {
            ...
            return capi.Render.UploadMesh(data);
        }
